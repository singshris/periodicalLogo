...
async function fetchData() {
  try {
    ...
    for (let i = 0; i < logos.length; i++) {
      ...
      console.log(x, y);
      // if (i > 0) {
      //   const prevXPos = positionsArray[i - 1].xPos;
      //   const distance = Math.abs(newxPos - prevXPos);
      //   if (distance > maxDistance) {
      //     // Limit the distance to the maximum
      //     newxPos = prevXPos + (newxPos > prevXPos ? maxDistance : -maxDistance);
      //   }
      // }
